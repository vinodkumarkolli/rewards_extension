<template>
  ...
  <div class="max-w-3xl py-6 mx-auto h-screen flex flex-col items-center justify-center relative z-10" v-if="id">
    ...
    <div v-if="voucherCampaign && tourCompleted && profileData && currentStep === 'coupon' && couponsUsed && ((couponsUsed.length-deniedPaymentCouponsCount) < voucherCampaign.unique_audience_redeem_limit)" class=" bg-yellow-50 rounded-lg shadow-lg flex border-yellow-200 flex-col items-center justify-center p-6 py-4 w-full max-w-md mx-auto space-y-2">
